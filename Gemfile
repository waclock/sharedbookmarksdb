...
gem "sendgrid", ">= 1.0.1"
gem "cancan", ">= 1.6.9"
#para declarar variables de entorno(en el application.yml). Se suben a heroku con: rake figaro:heroku
gem "figaro", ">= 0.6.3"
...
gem "database_cleaner", ">= 1.0.0.RC1", :group => :test#optimizations to clean between tests.
gem "email_spec", ">= 1.4.0", :group => :test #https://github.com/bmabey/email-spec
gem "factory_girl_rails", ">= 4.2.0", :group => [:development, :test]
gem "minitest", :group => :test
gem 'faker', '~> 1.3.0', :group => [:test]
