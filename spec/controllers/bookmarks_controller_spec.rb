  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bookmark as @bookmark" do
        ...
        post :create, {:bookmark => { "link" => "invalid value" }}, valid_session
        assigns(:bookmark).should be_a_new(Bookmark)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bookmark" do
        ...
        Bookmark.any_instance.should_receive(:update).with({ "link" => "MyString" })
        put :update, {:id => bookmark.to_param, :bookmark => { "link" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the bookmark as @bookmark" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Bookmark.any_instance.stub(:save).and_return(false)
        put :update, {:id => bookmark.to_param, :bookmark => { "link" => "invalid value" }}, valid_session
        assigns(:bookmark).should eq(bookmark)
      end
